    ...
    <div className="flex min-h-[70vh] items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          The page rolled credits, or it was never in the collection.
        </p>
        <div className="mt-6">
          <Link
            to="/movies"
  ...
  head: () => ({
    meta: [
      ...
      { title: "MovieGraph — Discover Your Next Favorite Movie" },
      {
        name: "description",
        content:
          "MovieGraph is a cinematic movie discovery app: browse films, track what you watch and like, and get graph-powered recommendations.",
      },
      { property: "og:title", content: "MovieGraph — Discover Your Next Favorite Movie" },
      {
        property: "og:description",
        content: "Browse films, track what you watch, and get graph-powered recommendations.",
      },
